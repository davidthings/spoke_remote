...
#define DARK_LARGE_STYLE_PROPS_COUNT  22

// Custom style name: darkLarge
static const GuiStyleProp darkLargeStyleProps[DARK_LARGE_STYLE_PROPS_COUNT] = {
...
#define DARK_LARGE_COMPRESSED_DATA_SIZE 1031

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
static unsigned char darkLargeFontData[DARK_LARGE_COMPRESSED_DATA_SIZE] = { 0xed,
...
static const Rectangle darkLargeFontRecs[95] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo darkLargeFontChars[95] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: darkLarge
static void GuiLoadStyleDarkLarge(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < DARK_LARGE_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(darkLargeStyleProps[i].controlId, darkLargeStyleProps[i].propertyId, darkLargeStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int darkLargeFontDataSize = 0;
    unsigned char *data = DecompressData(darkLargeFontData, DARK_LARGE_COMPRESSED_DATA_SIZE, &darkLargeFontDataSize);
    ...
    memcpy(font.recs, darkLargeFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)malloc(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, darkLargeFontChars, font.glyphCount*sizeof(GlyphInfo));
